            ...
            <div class="grid gap-4 md:grid-cols-4">
                @foreach($gallery as $image)
                    <div class="overflow-hidden rounded-2xl shadow-sm" data-reveal>
                        <img src="{{ asset($image->image_url) }}" alt="{{ $image->title }}" class="h-64 w-full object-cover transition duration-500 hover:scale-105" loading="lazy" width="600" height="600" />
                    </div>
                @endforeach
            </div>
        </div>
